...
<ul>
<li>
<a href="apps_email.html"><i class="os-icon os-icon-mail-01"></i><span>Profile</span></a></li>
<li><a href="users_profile_big.html"><i class="os-icon os-icon-user-male-circle2"></i><span>notification</span></a></li>
