  ...
  <div class="content-wrapper" >
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Create New Adminstrators</li>
      </ol>
    </section>
        ...
        <div class="col-md-6 col-xs-12 col-md-offset-2">
          ...
          <div class="box"  >
            <div class="box-header">
              <h3 class="box-title">Add Adminstrator</h3>
            </div>
            <form  id="createadminform" action="<?php base_url('users/admincreate') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('users/adminindex') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
           ...
           password: {
            ...
            cpassword: {
             ...
             status: {
                validators: {
                    notEmpty: {
                        message: 'You have to select the admin Status'
                    }
                }
            }
